...
func (x *Pagination) GetNextPage() int64 {
	if x != nil {
		return x.NextPage
	}
	return 0
...
func (x *Pagination) GetNumPages() int64 {
	if x != nil {
		return x.NumPages
	}
	return 0
...
func (x *Pagination) GetPer() int64 {
	if x != nil {
		return x.Per
	}
	return 0
...
func (x *Pagination) GetPrevPage() int64 {
	if x != nil {
		return x.PrevPage
	}
	return 0
...
const file_api_common_v1_pagination_proto_rawDesc = "" +
	"\n" +
	"\x1eapi/common/v1/pagination.proto\x12\fgh.common.v1\"\x9f\x01\n" +
	"\n" +
	"Pagination\x12\x14\n" +
	"\x05count\x18\x01 \x01(\x03R\x05count\x12\x1b\n" +
	"\tnext_page\x18\x02 \x01(\x03R\bnextPage\x12\x1b\n" +
...
var file_api_common_v1_pagination_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_api_common_v1_pagination_proto_goTypes = []any{
	(*Pagination)(nil), // 0: gh.common.v1.Pagination
}
